...
export class ShowClientFizComponent {
    ...
    this.currentClientFizSub$ = this.currentClientFizSelector.subscribe({
      next: (currentClientFiz) => {
        ...
        if (currentClientFiz) {
          ...
          this.pathValuePartner(currentClientFiz)
        }
  ...
  pathValuePartner(partner: ClientFiz) {
    this.form.patchValue({
      ...
      passport_address_fact: partner.passport_address_fact,
      prava_seria_number: partner.prava_seria + '-' + partner.prava_number,
      prava_date: partner.prava_date,
      phone_1: partner.phone_1,
      phone_2_dop_name: partner.phone_2_dop_name,
      phone_2_dop_number: partner.phone_2_dop_number,
      phone_3_dop_name: partner.phone_3_dop_name,
      phone_3_dop_number: partner.phone_3_dop_number,
      phone_4_dop_name: partner.phone_4_dop_name,
      phone_4_dop_number: partner.phone_4_dop_number,
      phone_5_dop_name: partner.phone_5_dop_name,
      phone_5_dop_number: partner.phone_5_dop_number,
      resident: partner.resident === 'true' ? true : false
    });

    this.file_1 = partner.file_1
    this.file_2 = partner.file_2
    this.file_3 = partner.file_3
    this.file_4 = partner.file_4
